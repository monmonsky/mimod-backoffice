...
class MenuController extends Controller
{
     ...
     */
    public function bulkCreateFromCategories(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'parent_id' => 'nullable|exists:menus,id',
            ...
            $created = $this->menuRepository->bulkCreateFromCategories($request->all());

            $result = (new ResultBuilder())
                ->setStatus(true)
                ->setStatusCode('201')
                ->setMessage(count($created) . ' menus created successfully from categories')
                ->setData($created);
            ...
            $result = (new ResultBuilder())
                ->setStatus(false)
                ->setStatusCode('500')
                ->setMessage('Failed to create menus from categories: ' . $e->getMessage())
                ->setData([]);
     ...
     */
    public function bulkCreateFromBrands(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'parent_id' => 'nullable|exists:menus,id',
            ...
            $created = $this->menuRepository->bulkCreateFromBrands($request->all());

            $result = (new ResultBuilder())
                ->setStatus(true)
                ->setStatusCode('201')
                ->setMessage(count($created) . ' menus created successfully from brands')
                ->setData($created);
            ...
            $result = (new ResultBuilder())
                ->setStatus(false)
                ->setStatusCode('500')
                ->setMessage('Failed to create menus from brands: ' . $e->getMessage())
                ->setData([]);
