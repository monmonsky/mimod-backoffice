...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'pulse.code', // Require access code
        Authorize::class,
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Simple access code to protect Pulse dashboard. Users will be prompted
    | to enter this code before accessing the dashboard.
    |
    */

    'access_code' => env('PULSE_ACCESS_CODE', 'secret123'),
