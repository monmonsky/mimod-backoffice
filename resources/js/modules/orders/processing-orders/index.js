            ...
            <tr>
                ...
                <td class="text-right">
                    <div class="inline-flex gap-2">
                        ${window.hasPermission && window.hasPermission('orders.processing-orders.view') ? `
                        ...
                        ` : ''}
                        ${window.hasPermission && window.hasPermission('orders.processing-orders.ship') ? `
                        <button class="btn btn-ghost btn-xs p-0 h-auto min-h-0 update-status-btn" data-id="${order.id}" data-status="shipped" title="Mark as Shipped">
                            <span class="iconify lucide--truck size-5 text-success"></span>
                        </button>
                        ` : ''}
                    </div>
                </td>
