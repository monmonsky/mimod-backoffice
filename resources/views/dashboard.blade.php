...
@section('page_subtitle', 'Welcome back! Here\'s what\'s happening with your store.')
                ...
                <div class="card-body p-0">
                    <div
                        ...
                        <div class="inline-flex items-center gap-2">
                            <div
                                class="text-base-content/60 w-6 border border-dashed"></div>
            ...
            <div aria-label="Card" class="card bg-base-100 shadow">
                <div class="card-body p-0">
                    <div class="flex items-center gap-3 px-5 pt-5">
                        <span
                            class="iconify lucide--shopping-bag size-4.5"></span>
...
<script src="{{ asset('assets/js/pages/dashboards/ecommerce.js') }}"></script>
<script>
