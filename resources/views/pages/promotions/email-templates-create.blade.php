...
@section('page_subtitle', 'Create Email Template')

@section('content')
<div class="flex items-center justify-between">
    <p class="text-lg font-medium">Create New Email Template</p>
            ...
            <div class="bg-base-100 card shadow">
                <div class="card-body">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="template_name" placeholder="e.g., Flash Sale Promo" class="input input-bordered" required />
                        <label class="label">
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="description" rows="2" class="textarea textarea-bordered" placeholder="Brief description of this template..."></textarea>
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="tags" placeholder="e.g., sale, discount, promotion" class="input input-bordered" />
                        <label class="label">
