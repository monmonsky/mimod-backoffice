...
<div class="flex items-center justify-between">
    <p class="text-lg font-medium">Edit Permission</p>
...
<form id="editPermissionForm" class="mt-6 space-y-6" data-id="{{ $permission->id }}">
    @csrf
    @method('PUT')
    ...
    <div class="bg-base-100 card shadow">
        <div class="card-body">
            ...
            <p class="text-sm text-base-content/70 mb-4">Update permission details</p>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        ...
                        <input type="text" name="name" class="input input-bordered w-full" required value="{{ $permission->name }}" placeholder="e.g., users.create">
                        <label class="label">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="display_name" class="input input-bordered w-full" required value="{{ $permission->display_name }}" placeholder="e.g., Create Users">
                        <label class="label">
                ...
                <div class="form-control">
                    ...
                    <select name="permission_group_id" class="select select-bordered w-full">
                        ...
                        @foreach($groups as $group)
                            <option value="{{ $group->id }}" {{ $permission->permission_group_id == $group->id ? 'selected' : '' }}>
                                {{ $group->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-control">
                    ...
                    <textarea name="description" class="textarea textarea-bordered h-24 w-full" placeholder="Permission description...">{{ $permission->description }}</textarea>
                </div>
            </div>
        </div>
    </div>
