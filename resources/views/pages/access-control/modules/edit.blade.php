...
<div class="flex items-center justify-between">
    <p class="text-lg font-medium">Edit Module</p>
...
<form id="editModuleForm" data-module-id="{{ $module->id }}" class="mt-6 space-y-6">
    @csrf
    @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        ...
                        <input type="text" name="name" class="input input-bordered w-full" required value="{{ $module->name }}" placeholder="e.g., users, products">
                        <label class="label">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="display_name" class="input input-bordered w-full" required value="{{ $module->display_name }}" placeholder="e.g., User Management">
                        <label class="label">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        ...
                        <input type="text" name="icon" class="input input-bordered w-full" value="{{ $module->icon }}" placeholder="e.g., lucide--users">
                        <label class="label">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="route" class="input input-bordered w-full" value="{{ $module->route }}" placeholder="e.g., user.index">
                        <label class="label">
                ...
                <div class="form-control">
                    ...
                    <textarea name="description" class="textarea textarea-bordered h-24 w-full" placeholder="Module description...">{{ $module->description }}</textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        ...
                        <select name="parent_id" class="select select-bordered w-full">
                            ...
                            @foreach($parents as $parent)
                                @if($parent->id != $module->id)
                                    <option value="{{ $parent->id }}" {{ $module->parent_id == $parent->id ? 'selected' : '' }}>
                                        {{ $parent->display_name }}
                                    </option>
                                @endif
                            @endforeach
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="sort_order" class="input input-bordered w-full" value="{{ $module->sort_order }}" placeholder="0">
                        <label class="label">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="component" class="input input-bordered w-full" value="{{ $module->component }}" placeholder="e.g., UserManagement">
                    <label class="label">
            ...
            <div class="space-y-4">
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-3">
                        <input type="checkbox" name="is_active" class="toggle toggle-primary" {{ $module->is_active ? 'checked' : '' }}>
                        <div>
                ...
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-3">
                        <input type="checkbox" name="is_visible" class="toggle toggle-primary" {{ $module->is_visible ? 'checked' : '' }}>
                        <div>
...
@section('customjs')
@vite(['resources/js/modules/access-control/modules/edit.js'])
@endsection
