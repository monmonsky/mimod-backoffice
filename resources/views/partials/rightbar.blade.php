                ...
                <div class="mt-3 grid grid-cols-3 gap-3">
                    <div
                        ...
                        <div class="bg-base-200 rounded-box pt-5 pb-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <span
                                    class="rounded-box bg-primary h-6 w-2 sm:w-3"></span>
                                <span
                                    class="rounded-box bg-secondary h-6 w-2 sm:w-3"></span>
                                <span
                                    class="rounded-box bg-accent h-6 w-2 sm:w-3"></span>
                                <span
                                    class="rounded-box bg-success h-6 w-2 sm:w-3"></span>
                            </div>
                    ...
                    <div
                        ...
                        <div class="bg-base-200 rounded-box pt-5 pb-3 text-center">
                            ...
                            <p class="mt-1.5 text-sm capitalize sm:text-base">
                                Contrast
                            </p>
                        </div>
                        <span
                    ...
                    <div
                        ...
                        <div class="bg-base-200 rounded-box pt-5 pb-3 text-center">
                            ...
                            <p class="mt-2.5 text-xs capitalize sm:text-sm">
                                Material Dark
                            </p>
                        </div>
                        <span
