            ...
            <div class="mb-3 space-y-0.5 px-2.5">
                ...
                @php
                    $hasGeneralsPermission = hasAnyPermission([
                        'settings.generals.store.view',
                        'settings.generals.email.view',
                        'settings.generals.seo.view',
                        'settings.generals.system.view',
                        'settings.generals.api-tokens.view'
                    ]);

                    $hasPaymentsPermission = hasAnyPermission([
                        'settings.payments.methods.view',
                        'settings.payments.midtrans.view',
                        'settings.payments.tax.view'
                    ]);

                    $hasShippingsPermission = hasAnyPermission([
                        'settings.shippings.methods.view',
                        'settings.shippings.rajaongkir.view',
                        'settings.shippings.origin.view'
                    ]);
                ...
                @if($hasAnySettings)
                        ...
                        <div class="group collapse">
                            ...
                            <div class="collapse-content ms-6.5 !p-0">
                                <div class="mt-0.5 space-y-0.5">
                                    @if(hasPermission('settings.generals.store.view'))
                                    ...
                                    @if(hasPermission('settings.generals.email.view'))
                                    ...
                                    @if(hasPermission('settings.generals.seo.view'))
                                    ...
                                    @if(hasPermission('settings.generals.system.view'))
                    ...
                    @if($hasPaymentsPermission)
                        <div class="group collapse">
                            ...
                            <div class="collapse-content ms-6.5 !p-0">
                                <div class="mt-0.5 space-y-0.5">
                                    @if(hasPermission('settings.payments.methods.view'))
                                    ...
                                    @if(hasPermission('settings.payments.midtrans.view'))
                                    ...
                                    @if(hasPermission('settings.payments.tax.view'))
                    ...
                    @if($hasShippingsPermission)
                        <div class="group collapse">
                            ...
                            <div class="collapse-content ms-6.5 !p-0">
                                <div class="mt-0.5 space-y-0.5">
                                    @if(hasPermission('settings.shippings.methods.view'))
                                    ...
                                    @if(hasPermission('settings.shippings.rajaongkir.view'))
                                    ...
                                    @if(hasPermission('settings.shippings.origin.view'))
